resource "aws_security_group" "bastion" {
  ...
  dynamic "ingress" {
    for_each = var.bastion_ing_ports
...
resource "aws_security_group" "int-lb" {
  name        = var.ilb_sg_name
  description = "Security Group for Internal Load Balancer" 
  vpc_id      = var.vpc_id

  dynamic "ingress" {
    for_each = var.ilb_ing_ports
...
resource "aws_security_group" "web_efs" {
  ...
  dynamic "ingress" {
    for_each = var.web_efs_ing_ports
...
resource "aws_security_group" "was_efs" {
  ...
  dynamic "ingress" {
    for_each = var.was_efs_ing_ports
